...
describe('couchwarehouse', () => {
  ...
  it('should save and retrieve the data correctly', (done) => {
    let select = 'SELECT * FROM sampledata ORDER BY id'
